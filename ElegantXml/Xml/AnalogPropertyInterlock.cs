...
{
    public class AnalogPropertyInterlock : ProcessorBase
    {
        /// <summary>
        /// A list of strings that are used to represent values in an XML attribute.
        /// </summary>
        public ushort[] PropertyValues { get; set; }

        /// <summary>
        /// The single SerialElement this interlock represents.
        /// </summary>
        public AnalogElement Element { get; set; }
        ...
        /// Used by Simpl+.
        /// </summary>
        public AnalogPropertyInterlock()
            : base()
        {
        }
        ...
        {
            PropertyValues = new ushort[quantity];
        }
        ...
        public ushort Initialize(ushort managerID, string elementPath)
        {
            ...
            try
            {
                ...
                Element = new AnalogElement(1, path, defVal);
            ...
            {
                Debug.PrintLine("Exception encountered while initializing Analog Property Interlock.");
        ...
        public void AddPropertyValue(ushort propertyIndex, ushort propertyValue)
        {
        ...
        public void SelectValueByIndex(ushort propertyIndex)
        {
            ...
            {
                Debug.PrintLine("Couldn't update value for Analog Property Interlock. The index value was out of range.");
                return;
            }
            try
            {
            ...
            {
                Debug.PrintLine("Exception encountered while updating Analog Property Interlock.");
        ...
        public void SelectValueByString(string value)
        {
            try
            {
                var newValue = ushort.Parse(value);
        ...
        public void SelectValue(ushort value)
        {
            if (!IsInitialized) { return; }
            try
            {
        ...
        public void ClearValue()
        {
            ...
            {
                Debug.PrintLine("Unable to clear values from Analog Property Interlock.");
            }
        }
